...
interface NBAPlayerValuationTableProps {
  ...
  sortOrder: "asc" | "desc";
  onSort: (
    column: keyof NBAPlayer | "valueDifference" | "valueDifferencePercent"
  ) => void;
}

export function NBAPlayerValuationTable({
  players,
  sortBy,
  sortOrder,
  onSort,
}: NBAPlayerValuationTableProps) {
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              >
                <div className="flex items-center justify-end">
                  Contract {renderSortIcon("marketValue")}
                </div>
              </TableHead>
              <TableHead
                className="cursor-pointer text-right"
                onClick={() => onSort("predictedValue")}
              >
                <div className="flex items-center justify-end">
                  Predicted {renderSortIcon("predictedValue")}
                </div>
              </TableHead>
              <TableHead
                className="cursor-pointer text-right"
                onClick={() => onSort("valueDifference")}
              >
                <div className="flex items-center justify-end">
                  Diff {renderSortIcon("valueDifference")}
                </div>
              </TableHead>
              ...
              paginatedPlayers.map((player) => {
                ...
                return (
                  <TableRow key={player.id}>
                    ...
                    <TableCell className="text-right font-medium">
                      {formatCurrency(player.predictedValue)}
                    </TableCell>
                    <TableCell className="text-right">
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <div
                              className={`flex items-center justify-end font-semibold ${getValueDifferenceColor(
                                player
                              )}`}
                            >
